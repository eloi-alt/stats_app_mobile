...
const translations: Translations = {
  ...
  'backToResults': { en: 'Back to results', fr: 'Retour aux résultats', es: 'Volver a los resultados' },
  'publicCard': { en: 'Public Card', fr: 'Carte Publique', es: 'Tarjeta Pública' },
  'noPublicCard': { en: 'No public card', fr: 'Pas de carte publique', es: 'Sin tarjeta pública' },
  'noPublicCardDesc': { en: 'This user hasn\'t created a card yet', fr: 'Cet utilisateur n\'a pas encore créé de carte', es: 'Este usuario aún no ha creado una tarjeta' },
  'proximity': { en: 'Proximity', fr: 'Proximité', es: 'Proximidad' },
  'closeFriend': { en: 'Close Friend', fr: 'Ami proche', es: 'Amigo cercano' },
  'alreadyFriends': { en: 'Already friends', fr: 'Déjà amis', es: 'Ya amigos' },
  'confirmDeleteFriend': { en: 'Do you really want to remove this friend?', fr: 'Voulez-vous vraiment supprimer cet ami ?', es: '¿Realmente quieres eliminar a este amigo?' },
  'removeFriend': { en: 'Remove from friends', fr: 'Supprimer de mes amis', es: 'Eliminar de mis amigos' },
  'requestSent': { en: 'Request sent', fr: 'Demande envoyée', es: 'Solicitud enviada' },
  'hasSentRequest': { en: 'Sent a request', fr: 'A envoyé une demande', es: 'Envió una solicitud' },
  ...
  'searchPlaceholder': { en: 'Username, first or last name...', fr: 'Nom d\'utilisateur, prénom ou nom...', es: 'Nombre de usuario, nombre o apellido...' },
  'noUserFound': { en: 'No user found', fr: 'Aucun utilisateur trouvé', es: 'Usuario no encontrado' },
  'tryAnotherUsername': { en: 'Try another username', fr: 'Essayez un autre nom d\'utilisateur', es: 'Prueba otro nombre de usuario' },
  'searchUsersCTA': { en: 'Search for users', fr: 'Recherchez des utilisateurs', es: 'Buscar usuarios' },
  'searchUsersDesc': { en: 'By username, first or last name', fr: 'Par nom d\'utilisateur, prénom ou nom', es: 'Por nombre de usuario, nombre o apellido' },
  'user': { en: 'User', fr: 'Utilisateur', es: 'Usuario' },
