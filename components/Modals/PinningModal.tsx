    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>Épingler un module</h2>
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Choisissez le module à afficher en premier</p>
          </div>
          <button
            onClick={onClose}
          ...
          {modules.map((module) => {
            ...
            return (
              <button
                ...
                style={!isPinned ? { background: 'var(--glass-bg)' } : undefined}
              >
                {/* Icon */}
                <div
                ...
                <div className="flex-1 text-left">
                  ...
                  <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>{module.subtitle}</div>
                </div>
                ...
                {/* Pin icon */}
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center ${isPinned ? 'bg-amber-400 text-black' : ''}`}
                  style={!isPinned ? { background: 'var(--glass-bg)', color: 'var(--text-tertiary)' } : undefined}
                >
